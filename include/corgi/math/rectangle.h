...
#include <corgi/math/detail/vector2.h>
...
// Methods
    ...
    */
    constexpr bool intersect(const Vector2<T>& a1, const Vector2<T>& a2, Vector2<T>& intersection)const
    {
        Vector2<T> v1;
        Vector2<T> v2;
        Vector2<T> v3;
        ...
        i1 += segment_intersect(Vector2<T>(_x, _y),            Vector2<T>(_x + _width, _y), a1, a2, v1);
        i2 += segment_intersect(Vector2<T>(_x, _y),            Vector2<T>(_x, _y + _height), a1, a2, v2);
        i3 += segment_intersect(Vector2<T>(_x, _y + _height),  Vector2<T>(_x + _width, _y + _height), a1, a2, v3);
        i4 += segment_intersect(Vector2<T>(_x + _width, _y),   Vector2<T>(_x + _width, _y + _height), a1, a2, v4);
