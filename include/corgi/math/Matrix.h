	...
	// Static Methods
		...
		*/
		...
		/*!
			...
			@param x,y,z Translation vector's coordinates
		*/
		...
		*/
		...
		/*!
			...
			@param top      Top border of the near plane
			@param znear    Distance between the center of the projection
			and the near plane
			@param zfar     Distance between the center of the projection
			and the far plane
		*/
