...
public:
	...
	{
		// Dans un premier temps, on vérifie que les vecteurs u et v de ab et cd ne sont pas colin�aire
		...
		// Si le déterminant n'est pas égal à 0, alors on cherche l'�quation des 2 droites AB et CD
...
// Functions
	...
	[[nodiscard]] Vec3 normalized()const
	{
		...
		if (l == 0)	// This probably should return a warning or something
		{
			return Vec3();
		}
