...
namespace corgi {
	...
	{
		const float cosa = math::cosf(angle);
		const float sina = math::sinf(angle);
	...
	{
		const float cosa = math::cosf(radian);
		const float sina = math::sinf(radian);
	...
	Matrix Matrix::inverse()const
	{
		// This is GLM way to compute the inverse matrix
			...
			/*float Coef00 = get_value(2,2) * get_value(3,3) - get_value(3,2) * get_value(2,3);
			float Coef02 = get_value(1,2) * get_value(3,3) - get_value(3,2) * get_value(1,3);
			float Coef03 = get_value(1,2) * get_value(2,3) - get_value(2,2) * get_value(1,3);

			float Coef04 = get_value(2,1) * get_value(3,3) - get_value(3,1) * get_value(2,3);
			float Coef06 = get_value(1,1) * get_value(3,3) - get_value(3,1) * get_value(1,3);
			float Coef07 = get_value(1,1) * get_value(2,3) - get_value(2,1) * get_value(1,3);

			float Coef08 = get_value(2,1) * get_value(3,2) - get_value(3,1) * get_value(2,2);
			float Coef10 = get_value(1,1) * get_value(3,2) - get_value(3,1) * get_value(1,2);
			float Coef11 = get_value(1,1) * get_value(2,2) - get_value(2,1) * get_value(1,2);

			float Coef12 = get_value(2,0) * get_value(3,3) - get_value(3,0) * get_value(2,3);
			float Coef14 = get_value(1,0) * get_value(3,3) - get_value(3,0) * get_value(1,3);
			float Coef15 = get_value(1,0) * get_value(2,3) - get_value(2,0) * get_value(1,3);

			float Coef16 = get_value(2,0) * get_value(3,2) - get_value(3,0) * get_value(2,2);
			float Coef18 = get_value(1,0) * get_value(3,2) - get_value(3,0) * get_value(1,2);
			float Coef19 = get_value(1,0) * get_value(2,2) - get_value(2,0) * get_value(1,2);

			float Coef20 = get_value(2,0) * get_value(3,1) - get_value(3,0) * get_value(2,1);
			float Coef22 = get_value(1,0) * get_value(3,1) - get_value(3,0) * get_value(1,1);
			float Coef23 = get_value(1,0) * get_value(2,1) - get_value(2,0) * get_value(1,1);
			...
			Vector4f Vec0(get_value(1,0), get_value(0,0), get_value(0,0), get_value(0,0));
			Vector4f Vec1(get_value(1,1), get_value(0,1), get_value(0,1), get_value(0,1));
			Vector4f Vec2(get_value(1,2), get_value(0,2), get_value(0,2), get_value(0,2));
			Vector4f Vec3(get_value(1,3), get_value(0,3), get_value(0,3), get_value(0,3));
			...
			Vector4f Row0(Inverse.get_value(0,0), Inverse.get_value(1,0), Inverse.get_value(2,0), Inverse.get_value(3,0));

			Vector4f Dot0(get_value(0, 0) * Row0.x,
						  get_value(0, 1) * Row0.y,
						  get_value(0, 2) * Row0.z,
						  get_value(0, 3) * Row0.w
						  );
